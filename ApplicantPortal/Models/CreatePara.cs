...
namespace ApplicantPortal
{
    public static class CreatePara
    {
        ...
        public static SqlParameter CreateParameter(this SqlParameter para, string paraName, Boolean paraVal, int size = 50, ParameterDirection dir = ParameterDirection.Input)
        {
            para.ParameterName = paraName;
            para.Value = paraVal;
            para.Size = size;
            para.SqlDbType = System.Data.SqlDbType.Bit;
            para.Direction = dir;
            return para;
        }
